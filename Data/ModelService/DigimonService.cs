    ...
    public class DigimonService
    {
        ...
        public Task<Digimon[]> GetDigimonDBAsync()
        {
            ...
            foreach (DataRow row in myData.Rows)
            {
                ...
                //if (row.IsNull("icon_name")) { d.IconName = ""; } else { d.IconName = (String)row.Field<Object>("icon_name"); }
                //if (row.IsNull("model_name")) { d.ModelName = ""; } else { d.ModelName = (String)row.Field<Object>("model_name"); }
